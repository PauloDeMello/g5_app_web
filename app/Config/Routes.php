...
$routes->get('/api/profile_picture', 'Settings::getImage'); // Add this line.
$routes->get('/settings', 'Settings::index'); // Add this line.

$routes->post('/settings/upload', 'Settings::upload'); // Add this line.
